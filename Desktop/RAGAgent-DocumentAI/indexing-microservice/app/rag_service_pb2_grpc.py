...
class RAGServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ProcessDocument = channel.unary_unary(
                ...
                request_serializer=rag__service__pb2.DocumentRequest.SerializeToString,
                response_deserializer=rag__service__pb2.DocumentResponse.FromString,
...
def add_RAGServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'ProcessDocument': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=rag__service__pb2.DocumentRequest.FromString,
                    response_serializer=rag__service__pb2.DocumentResponse.SerializeToString,
            ),
...
class RAGService(object):
    ...
    def ProcessDocument(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/rag.RAGService/ProcessDocument',
            rag__service__pb2.DocumentRequest.SerializeToString,
            rag__service__pb2.DocumentResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
